...
def run_leetcode_session(context):
    ...
    context.bot.send_message(job.context, text=LEETCODE_PROBLEMS[4])
    context.bot.send_message(job.context, text=LEETCODE_PROBLEMS[5])
